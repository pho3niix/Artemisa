...
export function BaseBuilderIcon() {
  return (
    <SvgIcon
      sx={{
        height: 72,
    ...
    >
      ...
      >
        ...
        <g transform="translate(20,10) scale(1.1)">
          ...
          {/* Bloques base */}
          <rect x="16" y="52" width="48" height="8" rx="4" fill="#FFFFFF" />
          <rect x="20" y="42" width="40" height="8" rx="4" fill="#E0E7FF" />
          <rect x="24" y="32" width="32" height="8" rx="4" fill="#C7D2FE" />

          {/* Flecha progreso */}
          <path
            d="M40 18 L54 32 H46 V46 H34 V32 H26 L40 18Z"
            fill="#22C55E"
          />
        </g>
