...
export default function EmployeeList() {
  ...
  // Estados iniciales leídos desde los query params de Next.js
  ...
  // Función auxiliar para actualizar la URL con los nuevos searchParams manteniendo los existentes
  ...
  const handleFilterModelChange = React.useCallback(
    (model: GridFilterModel) => {
      ...
      if (
        ...
        updateQueryParams({ filter: JSON.stringify(model) });
      } else {
  ...
  const handleSortModelChange = React.useCallback(
    (model: GridSortModel) => {
      ...
      if (model.length > 0) {
        updateQueryParams({ sort: JSON.stringify(model) });
      } else {
